...
export class World extends GameState {
  ...
  logicFrame(inputPacket) {
    ...
    if (this.iterations ==0) {
      for (let i = 0;i<100;i++) {
        for (let j = 0;j<100;j++) {
          ...
          if (i == 0 || j == 0) {
            this.createTile(i,j,true,(x,y) => {this.drawController.newRect(0,x,y,100,100,[0,0,0])})
          }
        }
      }
    }
    ...
    this.drawController.newRect(0,-1000- this.player.position.x,-1- this.player.position.y,2000,2,[0,0,0]) // axis
    this.drawController.newRect(0,-1- this.player.position.x,-1000- this.player.position.y,2,2000,[0,0,0]) // axis
    this.processTiles()
  }
};
